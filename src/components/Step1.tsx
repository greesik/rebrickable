...
export const API_KEY = "18084e47a78a9b554e4b69d454a2c169";
const API_URL = `https://rebrickable.com/api/v3/lego/minifigs/?key=${API_KEY}`;
...
export const Step1 = () => {
    ...
    useEffect(() => {
        const fetchMinifigures = async () => {
            try {
                const response = await axios.get<MinifiguresResponse>(API_URL, {
                    params: {
                        in_theme_id: 114,
                    },
                });
